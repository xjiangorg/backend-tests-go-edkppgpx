...
export IMAGE_URL=${IMAGE_URL-quay.io/quay_xjiang/backend-tests-go-edkppgpx:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/xjiangorg/backend-tests-go-edkppgpx-gitops
